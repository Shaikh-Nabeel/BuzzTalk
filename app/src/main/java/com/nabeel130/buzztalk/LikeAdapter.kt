...
class LikeAdapter(private val likedBy: ArrayList<String>) : RecyclerView.Adapter<LikeAdapter.LikeViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LikeViewHolder {
        return LikeViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.likes_view_item,parent,false))
    }
